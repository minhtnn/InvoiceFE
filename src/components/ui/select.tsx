...
function SelectContent({
  ...
  isLoading = false,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Content> & SelectContentProps) {
  const [localSearchValue, setLocalSearchValue] = React.useState(searchValue);

  React.useEffect(() => {
    // Đồng bộ lại khi props searchValue thay đổi từ bên ngoài
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        {searchable && totalPages > 1 && (
          <div className="flex items-center justify-between px-2 py-1 text-sm border-t text-muted-foreground">
            <button
